document.addEventListener('DOMContentLoaded', function () {
    /* ======= CÁC HÀM PHÁT HIỆN THIẾT BỊ (GIỮ NGUYÊN) ======= */
    function isIOS() {
    ...
    function triggerLink(url) {
        // Mở link trong tab mới để không làm hỏng trang hiện tại
        window.open(url, '_blank');
    }

    /* ======= LOGIC CHÍNH ĐÃ ĐƯỢC BỌC TRONG HÀM MAIN ======= */
    async function main() {
        // BƯỚC 1: KIỂM TRA THIẾT BỊ NGAY TỪ ĐẦU
        if (await isDesktop()) {
        ...
        // BƯỚC 2: NẾU LÀ MOBILE, TIẾP TỤC CHẠY LOGIC POPUP
